...
module cvt40_prefetch_buffer #(
  ...
  // Transaction request (between cvt40_prefetch_controller and cvt40_obi_interface)
  logic                     trans_valid;
  logic                     trans_ready;
  ...
  // Transaction response interface (between cvt40_obi_interface and cvt40_fetch_fifo)
  logic                     resp_valid;
...
`ifdef CV32E40P_ASSERT_ON
  ...
  // p_hwlp_end_already_gnt_when_hwlp_branch in cvt40_prefetch_controller
...
endmodule  // cvt40_prefetch_buffer
