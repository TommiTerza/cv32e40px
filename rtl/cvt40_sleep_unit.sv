...
module cvt40_sleep_unit #(
  ...
  generate
    if (COREV_CLUSTER) begin : g_pulp_sleep
      ...
      // cvt40_controller determines the scenarios for which WFI can(not) cause sleep.
  ...
  cvt40_clock_gate core_clock_gate_i (
      .clk_i       (clk_ungated_i),
      .en_i        (clock_en),
...
`ifdef CV32E40P_ASSERT_ON
  ...
  property p_clock_en_0;
    @(posedge clk_ungated_i) disable iff (!rst_n) ((id_stage_i.controller_i.ctrl_fsm_cs == cvt40_pkg::RESET) && (id_stage_i.controller_i.ctrl_fsm_ns == cvt40_pkg::RESET)) |-> (clock_en == 1'b0);
  endproperty
  ...
  property p_clock_en_1;
    @(posedge clk_ungated_i) disable iff (!rst_n) ((id_stage_i.controller_i.ctrl_fsm_cs == cvt40_pkg::RESET) && (id_stage_i.controller_i.ctrl_fsm_ns != cvt40_pkg::RESET)) |-> (clock_en == 1'b1);
  endproperty
  ...
  generate
    if (COREV_CLUSTER) begin : g_pulp_cluster_assertions
      ...
      property p_clock_en_3;
        @(posedge clk_ungated_i) disable iff (!rst_n) (clock_en == 1'b0) -> ((id_stage_i.controller_i.ctrl_fsm_cs == cvt40_pkg::RESET) || (COREV_CLUSTER && !pulp_clock_en_i));
      endproperty
      ...
      property p_clock_en_4;
        @(posedge clk_ungated_i) disable iff (!rst_n) (clock_en == 1'b0) -> ((id_stage_i.controller_i.ctrl_fsm_cs == cvt40_pkg::RESET) || (id_stage_i.controller_i.ctrl_fsm_ns == cvt40_pkg::SLEEP));
      endproperty
      ...
      property p_clock_en_5;
        @(posedge clk_ungated_i) disable iff (!rst_n)  ((id_stage_i.controller_i.ctrl_fsm_cs == cvt40_pkg::SLEEP) && (id_stage_i.controller_i.ctrl_fsm_ns != cvt40_pkg::SLEEP)) |-> (clock_en == 1'b1);
      endproperty
      ...
      property p_core_sleep;
        @(posedge clk_ungated_i) disable iff (!rst_n) (core_sleep_o == 1'b1) -> ((id_stage_i.controller_i.ctrl_fsm_cs == cvt40_pkg::SLEEP));
      endproperty
      ...
      property p_non_busy;
        @(posedge clk_ungated_i) disable iff (!rst_n) (core_busy_d == 1'b0) |-> (id_stage_i.controller_i.ctrl_fsm_cs == cvt40_pkg::WAIT_SLEEP) || (id_stage_i.controller_i.ctrl_fsm_cs == cvt40_pkg::SLEEP);
      endproperty
