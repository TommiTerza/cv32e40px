...
module cvt40_if_stage #(
    ...
    output cvt40_core_v_xif_pkg::x_compressed_req_t x_compressed_req_o,
    input cvt40_core_v_xif_pkg::x_compressed_resp_t x_compressed_resp_i,
