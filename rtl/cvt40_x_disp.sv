...
(
    ...
    input cvt40_pkg::PrivLvl_t current_priv_lvl_i,
  ...
  generate
    if (X_DUALREAD != 0) begin : gen_rs_dualread
      ...
      assign x_issue_req_ecs_valid = 1'b1;  // extension context status is not implemented in cvt40
  ...
  always_comb begin
    ...
    case (current_priv_lvl_i)
      cvt40_pkg::PRIV_LVL_M: x_issue_req_mode_o = 2'b11;
      cvt40_pkg::PRIV_LVL_H: x_issue_req_mode_o = 2'b10;
      cvt40_pkg::PRIV_LVL_S: x_issue_req_mode_o = 2'b01;
      cvt40_pkg::PRIV_LVL_U: x_issue_req_mode_o = 2'b00;
