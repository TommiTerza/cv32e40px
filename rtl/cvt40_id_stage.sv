...
module cvt40_id_stage
  import cvt40_pkg::*;
  import cvt40_apu_core_pkg::*;
  import cvt40_core_v_xif_pkg::*;
#(
  ...
  // FPU signals
  logic [cvt40_fpu_pkg::FP_FORMAT_BITS-1:0] fpu_src_fmt;
  logic [cvt40_fpu_pkg::FP_FORMAT_BITS-1:0] fpu_dst_fmt;
  logic [cvt40_fpu_pkg::INT_FORMAT_BITS-1:0] fpu_int_fmt;
  ...
  cvt40_int_controller #(
      ...
      // To/from with cvt40_cs_registers
...
`ifdef CV32E40P_ASSERT_ON
  ...
  always_comb begin
    if (FPU == 1) begin
      assert (APU_NDSFLAGS_CPU >= C_RM+2*cvt40_fpu_pkg::FP_FORMAT_BITS+cvt40_fpu_pkg::INT_FORMAT_BITS)
      else
        $error("[apu] APU_NDSFLAGS_CPU APU flagbits is smaller than %0d",
               C_RM + 2 * cvt40_fpu_pkg::FP_FORMAT_BITS + cvt40_fpu_pkg::INT_FORMAT_BITS);
    end
  end
