...
#(
  ...
  cvt40_if_stage #(
      ...
      .simt_cmd_valid_i(simt_cmd_valid),
      .simt_cmd_op_i   (simt_cmd_op),
      .simt_cmd_wid_i  (simt_cmd_wid),
      .simt_cmd_mask_i (simt_cmd_mask),
      .simt_cmd_pc_i   (simt_cmd_pc),
  ...
  cvt40_ex_stage #(
      ...
      // SIMT controls
      .simt_valid_i(simt_valid_ex),
      .simt_op_i   (simt_op_ex),
      .simt_rs1_i  (simt_rs1_ex),
      .simt_rs2_i  (simt_rs2_ex),
      .wid_i       (wid_ex),
