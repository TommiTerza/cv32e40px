...
//                                                                            //
// Design Name:    cvt40_core_log.sv (cvt40_core simulation log)        //
...
//                                                                            //
// Note:           This code was here from cvt40_core.sv and               //
//                 cvt40_controller.sv in order to remove the use of       //
//                 global defines in the RTL code.                            //
//                                                                            //
////////////////////////////////////////////////////////////////////////////////

module cvt40_core_log #(
  ...
  initial begin
    $display(
        "[cvt40_core]: COREV_PULP = %d, COREV_CLUSTER = %d, FPU %d, ZFINX %d, NUM_MHPMCOUNTERS %d",
